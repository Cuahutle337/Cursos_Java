...
<%@include file="comunes/navegacion.jsp"%>
	...
	<div class="container">
		...
		<div class="text-center" style="margin: 30px"></div>

		<h3 class="text-center" style="margin: 30px" >Sistemas de Empleados</h3>

		<div>
			<table class="table table-stripe table-hover table-bordered align-middle" >
